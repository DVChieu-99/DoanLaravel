                ...
                <table id="linh-vuc-table" class="table dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                         ...
                         <td> 
                            <a href="{{ route('linh-vuc.cap-nhat', ['id' => $linhVuc->id]) }}" class="btn btn-success btn-rounded waves-effect waves-light"><i class="mdi mdi-pencil-minus"></i></a>
                                                <!-- <a href="{{ route('linh-vuc.xoa', ['id' => $linhVuc->id]) }}" onclick="return confirm('Bạn có chắc muốn xóa')" class="btn btn-danger waves-effect waves-light"><i class=" mdi mdi-delete"></i></a>
                                                -->
