                ...
                <div class="row no-gutters">
                    <div class="col-md-6 col-xl-3">
                        <div class="widget-rounded-circle bg-soft-primary rounded-0 card-box mb-0">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1">{{DB::table('cau_hinh_app')->count()}}</h3>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="widget-rounded-circle bg-soft-warning rounded-0 card-box mb-0">
                            <div class="row">
                                <div class="col-6">
                                    <h4 class="header-title mt-0 mb-3">Danh sách điểm câu hỏi</h4>
                                ...
                                <div class="col-6">
                                    <div class="text-right">
                                        <h3 class="text-dark mt-1">{{DB::table('cau_hinh_diem_cau_hoi')->count()}}</h3>
